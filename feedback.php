...
<body>
    ...
    <main>
        <div class="container"><form method = "post" action = "home.php">
            ...
            <p><b>Тип обращения: </b>
            <center><select size = "1" style = "width: 200px;" name = "category">
                <option disabled class = "selector">Тип обращения</option>
                <option  class = "selector" value = "1">Жалоба</option>
                <option class = "selector" value = "2">Предложение</option>
            </select>
            </center></p>
